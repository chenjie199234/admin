...
type InstanceInfo struct {
	...
	MemType       string                 `protobuf:"bytes,7,opt,name=mem_type,json=memType,proto3" json:"mem_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_api_admin_app_proto_rawDesc = "" +
	...
	"\bweb_port\x18\n" +
	" \x01(\rB\x06\xb0\x91N\x80\x80\x04R\awebPort\"\xc9\x01\n" +
	...
	"\bmem_type\x18\a \x01(\tR\amemType\"\xa7\x01\n" +
