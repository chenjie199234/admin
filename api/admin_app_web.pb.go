	...
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/get_app] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						log.Error(ctx, "[/admin.app/get_app] data format wrong", log.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
...
func _App_SetApp_WebHandler(handler func(context.Context, *SetAppReq) (*SetAppResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/set_app] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						log.Error(ctx, "[/admin.app/set_app] data format wrong", log.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
			...
			if form := ctx.GetForm("dns_interval"); len(form) != 0 {
				if num, e := strconv.ParseUint(form, 10, 32); e != nil {
					log.Error(ctx, "[/admin.app/set_app] data format wrong", log.String("field", "dns_interval"))
					ctx.Abort(cerror.ErrReq)
					return
				} else {
			...
			if form := ctx.GetForm("crpc_port"); len(form) != 0 {
				if num, e := strconv.ParseUint(form, 10, 32); e != nil {
					log.Error(ctx, "[/admin.app/set_app] data format wrong", log.String("field", "crpc_port"))
					ctx.Abort(cerror.ErrReq)
					return
				} else {
			...
			if form := ctx.GetForm("cgrpc_port"); len(form) != 0 {
				if num, e := strconv.ParseUint(form, 10, 32); e != nil {
					log.Error(ctx, "[/admin.app/set_app] data format wrong", log.String("field", "cgrpc_port"))
					ctx.Abort(cerror.ErrReq)
					return
				} else {
			...
			if form := ctx.GetForm("web_port"); len(form) != 0 {
				if num, e := strconv.ParseUint(form, 10, 32); e != nil {
					log.Error(ctx, "[/admin.app/set_app] data format wrong", log.String("field", "web_port"))
					ctx.Abort(cerror.ErrReq)
					return
				} else {
			...
			if form := ctx.GetForm("new_app"); len(form) != 0 {
				if form == "true" {
					...
					log.Error(ctx, "[/admin.app/set_app] data format wrong", log.String("field", "new_app"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
...
func _App_DelApp_WebHandler(handler func(context.Context, *DelAppReq) (*DelAppResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/del_app] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						log.Error(ctx, "[/admin.app/del_app] data format wrong", log.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
...
func _App_UpdateAppSecret_WebHandler(handler func(context.Context, *UpdateAppSecretReq) (*UpdateAppSecretResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/update_app_secret] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						log.Error(ctx, "[/admin.app/update_app_secret] data format wrong", log.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
...
func _App_DelKey_WebHandler(handler func(context.Context, *DelKeyReq) (*DelKeyResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/del_key] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						log.Error(ctx, "[/admin.app/del_key] data format wrong", log.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
...
func _App_GetKeyConfig_WebHandler(handler func(context.Context, *GetKeyConfigReq) (*GetKeyConfigResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/get_key_config] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						log.Error(ctx, "[/admin.app/get_key_config] data format wrong", log.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
			...
			if form := ctx.GetForm("index"); len(form) != 0 {
				if num, e := strconv.ParseUint(form, 10, 32); e != nil {
					log.Error(ctx, "[/admin.app/get_key_config] data format wrong", log.String("field", "index"))
					ctx.Abort(cerror.ErrReq)
					return
				} else {
...
func _App_SetKeyConfig_WebHandler(handler func(context.Context, *SetKeyConfigReq) (*SetKeyConfigResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/set_key_config] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						log.Error(ctx, "[/admin.app/set_key_config] data format wrong", log.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
			...
			if form := ctx.GetForm("new_key"); len(form) != 0 {
				if form == "true" {
					...
					log.Error(ctx, "[/admin.app/set_key_config] data format wrong", log.String("field", "new_key"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
...
func _App_Rollback_WebHandler(handler func(context.Context, *RollbackReq) (*RollbackResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/rollback] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						log.Error(ctx, "[/admin.app/rollback] data format wrong", log.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
			...
			if form := ctx.GetForm("index"); len(form) != 0 {
				if num, e := strconv.ParseUint(form, 10, 32); e != nil {
					log.Error(ctx, "[/admin.app/rollback] data format wrong", log.String("field", "index"))
					ctx.Abort(cerror.ErrReq)
					return
				} else {
					req.Index = uint32(num)
...
func _App_WatchConfig_WebHandler(handler func(context.Context, *WatchConfigReq) (*WatchConfigResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			log.Error(ctx, "[/admin.app/watch_config] request message contain nested message or map,Content-Type must be application/json or application/x-protobuf")
			ctx.Abort(cerror.ErrReq)
			return
		}
		if errstr := req.Validate(); errstr != "" {
...
func _App_WatchDiscover_WebHandler(handler func(context.Context, *WatchDiscoverReq) (*WatchDiscoverResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/watch_discover] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectName
			...
			if form := ctx.GetForm("cur_dns_interval"); len(form) != 0 {
				if num, e := strconv.ParseUint(form, 10, 32); e != nil {
					log.Error(ctx, "[/admin.app/watch_discover] data format wrong", log.String("field", "cur_dns_interval"))
					ctx.Abort(cerror.ErrReq)
					return
				} else {
			...
			if form := ctx.GetForm("cur_crpc_port"); len(form) != 0 {
				if num, e := strconv.ParseUint(form, 10, 32); e != nil {
					log.Error(ctx, "[/admin.app/watch_discover] data format wrong", log.String("field", "cur_crpc_port"))
					ctx.Abort(cerror.ErrReq)
					return
				} else {
			...
			if form := ctx.GetForm("cur_cgrpc_port"); len(form) != 0 {
				if num, e := strconv.ParseUint(form, 10, 32); e != nil {
					log.Error(ctx, "[/admin.app/watch_discover] data format wrong", log.String("field", "cur_cgrpc_port"))
					ctx.Abort(cerror.ErrReq)
					return
				} else {
			...
			if form := ctx.GetForm("cur_web_port"); len(form) != 0 {
				if num, e := strconv.ParseUint(form, 10, 32); e != nil {
					log.Error(ctx, "[/admin.app/watch_discover] data format wrong", log.String("field", "cur_web_port"))
					ctx.Abort(cerror.ErrReq)
					return
				} else {
...
func _App_GetInstances_WebHandler(handler func(context.Context, *GetInstancesReq) (*GetInstancesResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/get_instances] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						log.Error(ctx, "[/admin.app/get_instances] data format wrong", log.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
			...
			if form := ctx.GetForm("with_info"); len(form) != 0 {
				if form == "true" {
					...
					log.Error(ctx, "[/admin.app/get_instances] data format wrong", log.String("field", "with_info"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
...
func _App_GetInstanceInfo_WebHandler(handler func(context.Context, *GetInstanceInfoReq) (*GetInstanceInfoResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/get_instance_info] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						log.Error(ctx, "[/admin.app/get_instance_info] data format wrong", log.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
...
func _App_SetProxy_WebHandler(handler func(context.Context, *SetProxyReq) (*SetProxyResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/set_proxy] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						log.Error(ctx, "[/admin.app/set_proxy] data format wrong", log.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
			...
			// req.Read
			if form := ctx.GetForm("read"); len(form) != 0 {
				if form == "true" {
					req.Read = true
				} else if form == "false" {
					req.Read = false
				} else {
					log.Error(ctx, "[/admin.app/set_proxy] data format wrong", log.String("field", "read"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			// req.Write
			if form := ctx.GetForm("write"); len(form) != 0 {
				if form == "true" {
					req.Write = true
				} else if form == "false" {
					req.Write = false
				} else {
					log.Error(ctx, "[/admin.app/set_proxy] data format wrong", log.String("field", "write"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if form := ctx.GetForm("admin"); len(form) != 0 {
				if form == "true" {
					...
					log.Error(ctx, "[/admin.app/set_proxy] data format wrong", log.String("field", "admin"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			// req.NewPath
			if form := ctx.GetForm("new_path"); len(form) != 0 {
				if form == "true" {
					req.NewPath = true
				} else if form == "false" {
					req.NewPath = false
				} else {
					log.Error(ctx, "[/admin.app/set_proxy] data format wrong", log.String("field", "new_path"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
...
func _App_DelProxy_WebHandler(handler func(context.Context, *DelProxyReq) (*DelProxyResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/del_proxy] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						log.Error(ctx, "[/admin.app/del_proxy] data format wrong", log.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
...
func _App_Proxy_WebHandler(handler func(context.Context, *ProxyReq) (*ProxyResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			...
			if e := ctx.ParseForm(); e != nil {
				log.Error(ctx, "[/admin.app/proxy] parse form failed", log.CError(e))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						log.Error(ctx, "[/admin.app/proxy] data format wrong", log.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
			...
			// req.ForceAddr
			if form := ctx.GetForm("force_addr"); len(form) != 0 {
				req.ForceAddr = form
			}
		}
		if errstr := req.Validate(); errstr != "" {
