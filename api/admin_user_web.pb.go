...
func _User_GetOauth2_WebHandler(handler func(context.Context, *GetOauth2Req) (*GetOauth2Resp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.user/get_oauth2] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/get_oauth2] unmarshal json body failed", slog.String("error", e.Error()))
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/get_oauth2] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.user/get_oauth2] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.SrcType
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.user/get_oauth2] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
...
func _User_UserLogin_WebHandler(handler func(context.Context, *UserLoginReq) (*UserLoginResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.user/user_login] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/user_login] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/user_login] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.user/user_login] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.SrcType
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.user/user_login] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _User_InviteProject_WebHandler(handler func(context.Context, *InviteProjectReq) (*InviteProjectResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.user/invite_project] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/invite_project] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/invite_project] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.user/invite_project] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.user/invite_project] data format wrong", slog.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.user/invite_project] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _User_KickProject_WebHandler(handler func(context.Context, *KickProjectReq) (*KickProjectResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.user/kick_project] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/kick_project] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/kick_project] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.user/kick_project] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.user/kick_project] data format wrong", slog.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.user/kick_project] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _User_SearchUsers_WebHandler(handler func(context.Context, *SearchUsersReq) (*SearchUsersResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.user/search_users] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/search_users] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/search_users] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.user/search_users] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.user/search_users] data format wrong", slog.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
			...
			if form := ctx.GetForm("only_project"); len(form) != 0 {
				if form == "true" {
					...
					slog.ErrorContext(ctx, "[/admin.user/search_users] data format wrong", slog.String("field", "only_project"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if form := ctx.GetForm("page"); len(form) != 0 {
				if num, e := strconv.ParseUint(form, 10, 32); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/search_users] data format wrong", slog.String("field", "page"))
					ctx.Abort(cerror.ErrReq)
					return
				} else {
					req.Page = uint32(num)
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.user/search_users] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _User_CreateRole_WebHandler(handler func(context.Context, *CreateRoleReq) (*CreateRoleResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.user/create_role] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/create_role] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/create_role] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.user/create_role] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.user/create_role] data format wrong", slog.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.user/create_role] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _User_SearchRoles_WebHandler(handler func(context.Context, *SearchRolesReq) (*SearchRolesResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.user/search_roles] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/search_roles] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/search_roles] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.user/search_roles] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.user/search_roles] data format wrong", slog.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
			...
			if form := ctx.GetForm("page"); len(form) != 0 {
				if num, e := strconv.ParseUint(form, 10, 32); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/search_roles] data format wrong", slog.String("field", "page"))
					ctx.Abort(cerror.ErrReq)
					return
				} else {
					req.Page = uint32(num)
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.user/search_roles] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _User_UpdateRole_WebHandler(handler func(context.Context, *UpdateRoleReq) (*UpdateRoleResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.user/update_role] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/update_role] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/update_role] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.user/update_role] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.user/update_role] data format wrong", slog.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.user/update_role] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _User_DelRoles_WebHandler(handler func(context.Context, *DelRolesReq) (*DelRolesResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.user/del_roles] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/del_roles] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/del_roles] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.user/del_roles] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.user/del_roles] data format wrong", slog.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.user/del_roles] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _User_AddUserRole_WebHandler(handler func(context.Context, *AddUserRoleReq) (*AddUserRoleResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.user/add_user_role] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/add_user_role] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/add_user_role] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.user/add_user_role] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.user/add_user_role] data format wrong", slog.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.user/add_user_role] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _User_DelUserRole_WebHandler(handler func(context.Context, *DelUserRoleReq) (*DelUserRoleResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.user/del_user_role] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/del_user_role] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.user/del_user_role] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.user/del_user_role] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.user/del_user_role] data format wrong", slog.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.user/del_user_role] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
