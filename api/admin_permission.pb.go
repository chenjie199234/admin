...
const file_api_admin_permission_proto_rawDesc = "" +
	"\n" +
	"\x1aapi/admin_permission.proto\x12\x05admin\x1a\x0fpbex/pbex.proto\"W\n" +
	"\x17get_user_permission_req\x12\x1d\n" +
	"\auser_id\x18\x01 \x01(\tB\x04\xe8\x90N\x00R\x06userId\x12\x1d\n" +
	"\anode_id\x18\x02 \x03(\rB\x04\x98\x90N\x01R\x06nodeId\"f\n" +
	"\x18get_user_permission_resp\x12\x18\n" +
	"\acanread\x18\x01 \x01(\bR\acanread\x12\x1a\n" +
	"\bcanwrite\x18\x02 \x01(\bR\bcanwrite\x12\x14\n" +
	"\x05admin\x18\x03 \x01(\bR\x05admin\"\xa6\x01\n" +
	"\x1aupdate_user_permission_req\x12\x1d\n" +
	"\auser_id\x18\x01 \x01(\tB\x04\xe8\x90N\x00R\x06userId\x12\x1d\n" +
	...
	"\bcanwrite\x18\x05 \x01(\bR\bcanwrite\"\x1d\n" +
	"\x1bupdate_user_permission_resp\"\xcf\x01\n" +
	"\x1aupdate_role_permission_req\x12#\n" +
	"\n" +
	...
	"\bcanwrite\x18\x06 \x01(\bR\bcanwrite\"\x1d\n" +
	"\x1bupdate_role_permission_resp\"o\n" +
	"\fadd_node_req\x12\x1f\n" +
	...
	"\radd_node_resp\x12\x17\n" +
	"\anode_id\x18\x01 \x03(\rR\x06nodeId\"~\n" +
	"\x0fupdate_node_req\x12\x1d\n" +
	"\anode_id\x18\x01 \x03(\rB\x04\x98\x90N\x02R\x06nodeId\x12(\n" +
	"\rnew_node_name\x18\x02 \x01(\tB\x04\xe8\x90N\x00R\vnewNodeName\x12\"\n" +
	"\rnew_node_data\x18\x03 \x01(\tR\vnewNodeData\"\x12\n" +
	"\x10update_node_resp\"O\n" +
	"\rmove_node_req\x12\x1d\n" +
	"\anode_id\x18\x01 \x03(\rB\x04\x98\x90N\x02R\x06nodeId\x12\x1f\n" +
	"\bpnode_id\x18\x02 \x03(\rB\x04\xa0\x90N\x02R\apnodeId\"\x10\n" +
	"\x0emove_node_resp\"-\n" +
	"\fdel_node_req\x12\x1d\n" +
	"\anode_id\x18\x01 \x03(\rB\x04\x98\x90N\x02R\x06nodeId\"\x0f\n" +
	"\rdel_node_resp\"\xd8\x01\n" +
	"\tnode_info\x12\x17\n" +
	...
	"\bchildren\x18\a \x03(\v2\x10.admin.node_infoR\bchildren\"\x81\x01\n" +
	"\x12list_user_node_req\x12#\n" +
	"\n" +
	"project_id\x18\x01 \x03(\rB\x04\x88\x90N\x02R\tprojectId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12-\n" +
	"\x13need_user_role_node\x18\x03 \x01(\bR\x10needUserRoleNode\";\n" +
	"\x13list_user_node_resp\x12$\n" +
	"\x04node\x18\x01 \x01(\v2\x10.admin.node_infoR\x04node\"\\\n" +
	"\x12list_role_node_req\x12#\n" +
	"\n" +
	"project_id\x18\x01 \x03(\rB\x04\x88\x90N\x02R\tprojectId\x12!\n" +
	"\trole_name\x18\x02 \x01(\tB\x04\xe8\x90N\x00R\broleName\";\n" +
	"\x13list_role_node_resp\x12$\n" +
	"\x04node\x18\x01 \x01(\v2\x10.admin.node_infoR\x04node\"<\n" +
	"\x15list_project_node_req\x12#\n" +
	"\n" +
	"project_id\x18\x01 \x03(\rB\x04\x88\x90N\x02R\tprojectId\">\n" +
	"\x16list_project_node_resp\x12$\n" +
	"\x04node\x18\x01 \x01(\v2\x10.admin.node_infoR\x04node2\xb4\a\n" +
	"\n" +
	"permission\x12m\n" +
	"\x13get_user_permission\x12\x1e.admin.get_user_permission_req\x1a\x1f.admin.get_user_permission_resp\"\x15\x8a\x9fI\x04post\x92\x9fI\taccesskey\x12r\n" +
	"\x16update_user_permission\x12!.admin.update_user_permission_req\x1a\".admin.update_user_permission_resp\"\x11\x8a\x9fI\x04post\x92\x9fI\x05token\x12r\n" +
	"\x16update_role_permission\x12!.admin.update_role_permission_req\x1a\".admin.update_role_permission_resp\"\x11\x8a\x9fI\x04post\x92\x9fI\x05token\x12H\n" +
	"\badd_node\x12\x13.admin.add_node_req\x1a\x14.admin.add_node_resp\"\x11\x8a\x9fI\x04post\x92\x9fI\x05token\x12Q\n" +
	"\vupdate_node\x12\x16.admin.update_node_req\x1a\x17.admin.update_node_resp\"\x11\x8a\x9fI\x04post\x92\x9fI\x05token\x12K\n" +
	"\tmove_node\x12\x14.admin.move_node_req\x1a\x15.admin.move_node_resp\"\x11\x8a\x9fI\x04post\x92\x9fI\x05token\x12H\n" +
	"\bdel_node\x12\x13.admin.del_node_req\x1a\x14.admin.del_node_resp\"\x11\x8a\x9fI\x04post\x92\x9fI\x05token\x12Z\n" +
	"\x0elist_user_node\x12\x19.admin.list_user_node_req\x1a\x1a.admin.list_user_node_resp\"\x11\x8a\x9fI\x04post\x92\x9fI\x05token\x12Z\n" +
	"\x0elist_role_node\x12\x19.admin.list_role_node_req\x1a\x1a.admin.list_role_node_resp\"\x11\x8a\x9fI\x04post\x92\x9fI\x05token\x12c\n" +
	"\x11list_project_node\x12\x1c.admin.list_project_node_req\x1a\x1d.admin.list_project_node_resp\"\x11\x8a\x9fI\x04post\x92\x9fI\x05tokenB(Z&github.com/chenjie199234/admin/api;apib\x06proto3"
