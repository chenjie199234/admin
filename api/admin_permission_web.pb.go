...
// version:
// 	protoc-gen-go-web v0.0.118-dev<br />
// 	protoc            v5.28.0<br />
...
func _Permission_GetUserPermission_WebHandler(handler func(context.Context, *GetUserPermissionReq) (*GetUserPermissionResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/get_user_permission] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/get_user_permission] unmarshal json body failed", slog.String("error", e.Error()))
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/get_user_permission] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/get_user_permission] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.UserId
			...
			if forms := ctx.GetForms("node_id"); len(forms) > 0 {
				req.NodeId = make([]uint32, 0, len(forms))
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.permission/get_user_permission] data format wrong", slog.String("field", "node_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.NodeId = append(req.NodeId, uint32(num))
					}
				}
			}
		}
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.permission/get_user_permission] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
...
func _Permission_UpdateUserPermission_WebHandler(handler func(context.Context, *UpdateUserPermissionReq) (*UpdateUserPermissionResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/update_user_permission] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/update_user_permission] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/update_user_permission] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/update_user_permission] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.UserId
			...
			if forms := ctx.GetForms("node_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.permission/update_user_permission] data format wrong", slog.String("field", "node_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.NodeId = append(req.NodeId, uint32(num))
			...
			if form := ctx.GetForm("admin"); len(form) != 0 {
				if form == "true" {
					...
					slog.ErrorContext(ctx, "[/admin.permission/update_user_permission] data format wrong", slog.String("field", "admin"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if form := ctx.GetForm("canread"); len(form) != 0 {
				if form == "true" {
					...
					slog.ErrorContext(ctx, "[/admin.permission/update_user_permission] data format wrong", slog.String("field", "canread"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if form := ctx.GetForm("canwrite"); len(form) != 0 {
				if form == "true" {
					...
					slog.ErrorContext(ctx, "[/admin.permission/update_user_permission] data format wrong", slog.String("field", "canwrite"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.permission/update_user_permission] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _Permission_UpdateRolePermission_WebHandler(handler func(context.Context, *UpdateRolePermissionReq) (*UpdateRolePermissionResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/update_role_permission] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/update_role_permission] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/update_role_permission] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/update_role_permission] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.permission/update_role_permission] data format wrong", slog.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
			...
			if forms := ctx.GetForms("node_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.permission/update_role_permission] data format wrong", slog.String("field", "node_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.NodeId = append(req.NodeId, uint32(num))
			...
			if form := ctx.GetForm("admin"); len(form) != 0 {
				if form == "true" {
					...
					slog.ErrorContext(ctx, "[/admin.permission/update_role_permission] data format wrong", slog.String("field", "admin"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if form := ctx.GetForm("canread"); len(form) != 0 {
				if form == "true" {
					...
					slog.ErrorContext(ctx, "[/admin.permission/update_role_permission] data format wrong", slog.String("field", "canread"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if form := ctx.GetForm("canwrite"); len(form) != 0 {
				if form == "true" {
					...
					slog.ErrorContext(ctx, "[/admin.permission/update_role_permission] data format wrong", slog.String("field", "canwrite"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.permission/update_role_permission] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _Permission_AddNode_WebHandler(handler func(context.Context, *AddNodeReq) (*AddNodeResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/add_node] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/add_node] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/add_node] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/add_node] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.PnodeId
			if forms := ctx.GetForms("pnode_id"); len(forms) > 0 {
				req.PnodeId = make([]uint32, 0, len(forms))
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.permission/add_node] data format wrong", slog.String("field", "pnode_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.PnodeId = append(req.PnodeId, uint32(num))
					}
				}
			}
			// req.NodeName
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.permission/add_node] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _Permission_UpdateNode_WebHandler(handler func(context.Context, *UpdateNodeReq) (*UpdateNodeResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/update_node] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/update_node] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/update_node] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/update_node] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.NodeId
			if forms := ctx.GetForms("node_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.permission/update_node] data format wrong", slog.String("field", "node_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.NodeId = append(req.NodeId, uint32(num))
			...
			if form := ctx.GetForm("new_node_name"); len(form) != 0 {
				req.NewNodeName = form
			}
			// req.NewNodeData
			if form := ctx.GetForm("new_node_data"); len(form) != 0 {
				req.NewNodeData = form
			}
		}
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.permission/update_node] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _Permission_MoveNode_WebHandler(handler func(context.Context, *MoveNodeReq) (*MoveNodeResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/move_node] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/move_node] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/move_node] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/move_node] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.NodeId
			if forms := ctx.GetForms("node_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.permission/move_node] data format wrong", slog.String("field", "node_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.NodeId = append(req.NodeId, uint32(num))
			...
			if forms := ctx.GetForms("pnode_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.permission/move_node] data format wrong", slog.String("field", "pnode_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.PnodeId = append(req.PnodeId, uint32(num))
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.permission/move_node] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _Permission_DelNode_WebHandler(handler func(context.Context, *DelNodeReq) (*DelNodeResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/del_node] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/del_node] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/del_node] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/del_node] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.NodeId
			if forms := ctx.GetForms("node_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.permission/del_node] data format wrong", slog.String("field", "node_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.NodeId = append(req.NodeId, uint32(num))
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.permission/del_node] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _Permission_ListUserNode_WebHandler(handler func(context.Context, *ListUserNodeReq) (*ListUserNodeResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/list_user_node] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/list_user_node] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/list_user_node] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/list_user_node] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.permission/list_user_node] data format wrong", slog.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
			...
			// req.NeedUserRoleNode
			if form := ctx.GetForm("need_user_role_node"); len(form) != 0 {
				if form == "true" {
					req.NeedUserRoleNode = true
				} else if form == "false" {
					req.NeedUserRoleNode = false
				} else {
					slog.ErrorContext(ctx, "[/admin.permission/list_user_node] data format wrong", slog.String("field", "need_user_role_node"))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.permission/list_user_node] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _Permission_ListRoleNode_WebHandler(handler func(context.Context, *ListRoleNodeReq) (*ListRoleNodeResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/list_role_node] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/list_role_node] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/list_role_node] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/list_role_node] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.permission/list_role_node] data format wrong", slog.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.permission/list_role_node] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
...
func _Permission_ListProjectNode_WebHandler(handler func(context.Context, *ListProjectNodeReq) (*ListProjectNodeResp, error)) web.OutsideHandler {
	return func(ctx *web.Context) {
		...
		if strings.HasPrefix(ctx.GetContentType(), "application/json") {
			data, e := ctx.GetBody()
			if e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/list_project_node] get body failed", slog.String("error", e.Error()))
				ctx.Abort(e)
				return
			}
			if len(data) > 0 {
				if e := (protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}).Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/list_project_node] unmarshal json body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if len(data) > 0 {
				if e := proto.Unmarshal(data, req); e != nil {
					slog.ErrorContext(ctx, "[/admin.permission/list_project_node] unmarshal proto body failed", slog.String("error", e.Error()))
					ctx.Abort(cerror.ErrReq)
					return
				}
			}
			...
			if e := ctx.ParseForm(); e != nil {
				slog.ErrorContext(ctx, "[/admin.permission/list_project_node] parse form failed", slog.String("error", e.Error()))
				ctx.Abort(cerror.ErrReq)
				return
			}
			// req.ProjectId
			if forms := ctx.GetForms("project_id"); len(forms) > 0 {
				...
				for _, form := range forms {
					if num, e := strconv.ParseUint(form, 10, 32); e != nil {
						slog.ErrorContext(ctx, "[/admin.permission/list_project_node] data format wrong", slog.String("field", "project_id"))
						ctx.Abort(cerror.ErrReq)
						return
					} else {
						req.ProjectId = append(req.ProjectId, uint32(num))
		...
		if errstr := req.Validate(); errstr != "" {
			slog.ErrorContext(ctx, "[/admin.permission/list_project_node] validate failed", slog.String("error", errstr))
			ctx.Abort(cerror.ErrReq)
			return
		}
		resp, e := handler(ctx, req)
